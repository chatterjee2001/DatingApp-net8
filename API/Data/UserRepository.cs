...
public class UserRepository(DataContext context, IMapper mapper) : IUserRepositiry
{
    ...
    {
        return await context.Users.Include(c=>c.Photos).SingleOrDefaultAsync(x => x.UserName == username);
    }
